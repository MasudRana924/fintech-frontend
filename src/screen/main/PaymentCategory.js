    ...
    return (
        <div className="mt-16 lg:mt-24 border border-white bg-white rounded-lg ml-2 mr-2 shadow-lg">
            <div className="flex justify-around mt-2">
                <div>
                    <Link to="/send">
                        <AiOutlineIdcard className="text-4xl text-violet-500 mb-1"></AiOutlineIdcard>
                ...
                <div >
                    <Link to="/cashout">
                        ...
                        <div className="flex">
                            <BiMenuAltLeft className="text-4xl  text-violet-500  mb-1">ট</BiMenuAltLeft>
                            <p className="text-sm font-thin text-violet-500 mb-1 mt-3">ট</p>
                        </div>
                ...
                <div onClick={handleClick}>
                    <FaRegMoneyBillAlt className="text-4xl text-gray-300  mb-1"></FaRegMoneyBillAlt>
                    <p className="paymentCategory-text font-medium text-gray-300  text-start">রিচার্জ</p>
                </div>
                <div >
                    <Link to="/payment/number">
                        <BsBagFill className="text-4xl text-violet-500 mb-1"></BsBagFill>
            ...
            <div className="mt-5 flex justify-around mb-4" >
                <div onClick={handleClick}>
                    <Link to="">
                        <BsSend className="text-4xl text-gray-300 mb-1"></BsSend>
                        <p className="paymentCategory-text  text-start font-medium text-gray-300">এ্যাড মানি</p>
                    </Link>
                </div>
                <div onClick={handleClick}>
                    <BsLightbulb className="text-4xl  text-gray-300  mb-1"></BsLightbulb>
                    <p className="paymentCategory-text text-start text-gray-300 font-medium">পে-বিল</p>
                </div>
                <div >
                    <Link to="/savings">
                        <GiChipsBag className="text-4xl text-violet-500  mb-1"></GiChipsBag>
                ...
                <div>
                    <Link to="/apply/loan">
                        <FaHandHoldingUsd className="text-4xl text-violet-500 mb-1"></FaHandHoldingUsd>
